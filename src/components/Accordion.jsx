...
const Accordion = () => {
  ...
  return (
    <div className='pt-[149px] mb-28 lg:mb-60 max-w-[540px] mx-auto flex flex-col justify-center items-center pr-4 lg:pr-0'>
        ...
        <p className='text-[15px] lg:text-[18px] text-grayish text-center max-w-[310px] lg:max-w-[640px] pb-[56px]'>Here are some of our FAQs. If you have any other questions you’d like answered please feel free to email us.</p>
        <div className='max-w-[320px] lg:min-w-[540px]'>
        {info.map((item, key) => (
            <AccordionItem key={key} name={item.name} description={item.answer} />
        ))}
        <hr className='border-0.1 border-gray-300' />
        </div>
        <div className='flex justify-center'>
          <button className='mb-[10px] max-w-[114px] font-medium cursor-pointer mt-[54px] bg-softblue py-2.5 px-5 rounded-md text-white text-[14px]'>More Info</button>
        </div>
